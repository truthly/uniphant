EXTENSION = uniphant
DATA = uniphant--1.4.sql uniphant--1.3--1.4.sql

REGRESS = test
EXTRA_CLEAN = uniphant--1.4.sql uniphant--1.3--1.4.sql

PG_CONFIG = pg_config
PGXS := $(shell $(PG_CONFIG) --pgxs)
include $(PGXS)

all: uniphant--1.4.sql uniphant--1.3--1.4.sql
